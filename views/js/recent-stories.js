// DOM elements
      ...
      async function showStoryModal(storyId) {
        try {
          ...
          if (story.image_data || story.image_base64) {
            modalStoryImage.src = `data:image/${
              story.image_format || "png"
            };base64,${story.image_data || story.image_base64}`;
      ...
      function showModal() {
        ...
        setTimeout(() => {
          ...
          storyModal.querySelector(".modal-content").style.transform =
            "scale(1)";
        }, 10);
      }
