...
document.addEventListener("DOMContentLoaded", () => {
  ...
  // TEMPORARY: Test dropdown functionality
  setTimeout(() => {
...
// Temporary function to test dropdown functionality
function testDropdownAsLoggedInUser() {
  console.log("Testing dropdown as logged-in user...");
  ...
  if (dropdownUserName) dropdownUserName.textContent = "Test User";
  if (dropdownUserEmail) dropdownUserEmail.textContent = "test@example.com";
  if (userAvatar)
    userAvatar.src = "https://via.placeholder.com/40x40/4361ee/ffffff?text=T";
  if (dropdownAvatar)
    dropdownAvatar.src =
      "https://via.placeholder.com/40x40/4361ee/ffffff?text=T";

  console.log("Test user simulation complete");
}
